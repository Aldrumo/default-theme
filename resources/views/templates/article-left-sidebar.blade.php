<x-DefaultTheme::app-layout>
    ...
    <section class="text-gray-600 body-font">
        <div class="container flex flex-wrap px-5 py-10 mx-auto items-top">
            <div class="flex flex-col md:w-1/5 md:pr-12 text-right">
            ...
            <div class="md:w-4/5 md:pl-12 md:pb-8 md:border-l md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200 text-base">
